...
$(document).ready(function () {
  ...
  var waypoint = new Waypoint({
    ...
    handler: function () {
      ...
      p[3].setAttribute("style", "width:90%;transition:1.5s all;");
      p[4].setAttribute("style", "width:90%;transition:1.7s all;");
      p[5].setAttribute("style", "width:85%;transition:2s all;");
      p[6].setAttribute("style", "width:80%;transition:2.3s all;");
      p[7].setAttribute("style", "width:75%;transition:2.5s all;");
  ...
  var typed = new Typed(".element", {
    strings: ["Ijaz Hossain", "a Javascript Developer", "a React Developer", "a MERN Stack Developer", "a Full Stack Developer"],
    smartBackspace: true,
    typeSpeed: 100,
    backSpeed: 100,
    loop: true,
